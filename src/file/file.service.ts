    ...
    public transformData(data: { fileUrl: string }[]): any {
        ...
        data.forEach(({ fileUrl }) => {
            ...
            pathParts.forEach((part, index) => {
                ...
                const isFileName = index === pathParts.length - 1 && decodedPart.includes('.');
                ...
                let existingFolder = currentLevel.find((cl: any) => typeof cl === 'object' && Object.keys(cl)[0] === decodedPart);
